/* This class is modified from MALLET software. Please see below for more 
...
public class LDAModel implements Serializable{
	...
	public double vBeta;
	public InstanceList ilist;  // the data field of the instances is expected to hold a FeatureSequence
	public int[][] topics; // indexed by <document index, sequence index>
	public int numTypes;
	public int numTokens;
	public int[][] docTopicCounts; // indexed by <document index, topic index>
	public int[][] typeTopicCounts; // indexed by <feature index, topic index>
	public int[] tokensPerTopic; // indexed by <topic index>

	public LDAModel (int numberOfTopics)
	{
		this (numberOfTopics, 50.0, 0.01);
	}

	public LDAModel (int numberOfTopics, double alphaSum, double beta)
	{
